...
object TcnConstants {
    ...
    //private const val UUID_SERVICE_STRING = "426c7565-4368-6172-6d42-6561636f6e73"

    val UUID_SERVICE: UUID = UUID.fromString(UUID_SERVICE_STRING)

    private const val BEACON_UUID_SERVICE_STRING = "426c7565-4368-6172-6d42-6561636fabcd"

    val BEACON_UUID_SERVICE: UUID = UUID.fromString(BEACON_UUID_SERVICE_STRING)

    private const val iOS_BEACON_UUID_SERVICE_STRING = "0000C019-0000-1000-8000-00805F9Babcd"

    val iOS_BEACON_UUID_SERVICE: UUID = UUID.fromString(iOS_BEACON_UUID_SERVICE_STRING)
    ...
    const val API_BEACON_TCN_RETRIEVAL_URL = "https://your_api_domain.com/api/v1/beacon_report/"
    const val API_CT_KEY = "api_symmetric_key"
}
